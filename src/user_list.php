        ...
        foreach ($events as $eventId => $event) {
            ...
            if (isset($user['record'][$eventId])) {
                ...
                if (empty($slot)) {
                    ...
                    } elseif ($user['record'][$eventId]['participant_status'] == CANCELED) {
                        $action = '';
                    } else {
