User = {
    ...
    init: function () {
        ...
        jQuery(document).on("click", ".get-list", function () {
            ...
            ;
            jQuery.ajax({
                'url': User.listURL + "&event_id=" + User.slotsEventId + "&baseline=" + jQuery(this).data('baseline') + "&offset=" + jQuery(this).data('offset') + "&affiliation=" + jQuery(this).data('affiliation') + "&canceled_baseline=" + jQuery(this).data('canceled-baseline') + "&reservation_event_id=" + jQuery(this).data('key'),
                'type': 'GET',
                'beforeSend': function () {
                    /**
